...
from chapter_04_heap_sort.heap_sort import heap_sort
...
if __name__ == '__main__':
    ...
    test_sort('heap_sort', heap_sort, arr1[:])
    print('*' * 20)
    ...
    test_sort('heap_sort', heap_sort, arr2[:])
    print('*' * 20)
    ...
    test_sort('heap_sort', heap_sort, arr3[:])
    print('*' * 20)
